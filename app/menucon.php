<?php
  define("URL_ADMIN", "http://localhost/doan-php/final-course/app/admin/");
?>
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container">
    <a class="navbar-brand" href="http://localhost/doan-php/final-course/app/">VEST HOME</a>
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown01">
            ...
            <a class="dropdown-item" href="<?php echo URL_ADMIN; ?>usres/new.php">Thêm mới Users</a>
          </div>
        </li>
        <li class="nav-item dropdown">
